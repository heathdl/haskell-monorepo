...
strictlyNonPalindromicNumbers = 0 : 1 : 2 : 3 : 4 : 6 : filter isStrictlyNonPalindromicNumber (drop 2 primes)

isStrictlyNonPalindromicNumber :: (Integral a) => a -> Bool
isStrictlyNonPalindromicNumber = null . tail . getPalindromicBasesOf

-- https://oeis.org/A107129
highlyPalindromicNumbers :: (Integral a) => [a]
highlyPalindromicNumbers = 1 : 3 : 5 : 10 : 21 : 36 : 60 : 80 : highlyPalindromicNumbers [120, 132 ..] 6
  where
